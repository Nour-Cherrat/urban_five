    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    <!-- ***** Logo Start ***** -->
                    <a href="index.html" class="logo">Urban<em> 5</em></a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="section-heading">
                    ...
                    <p>Le Studio de Formation est un modèle CSS gratuit pour les gymnases et les centres de fitness. Vous êtes
...
<section class="section" id="our-classes">
    <div class="container">
        ...
        <div class="row" id="tabs">
            <div class="col-lg-4">
                <ul>
                    <li><a href='#tabs-1'><img src="assets/images/tabs-first-icon.png" alt="">Premier Cours de Formation</a>
                    </li>
            ...
            <div class="col-lg-4">
                <div class="trainer-item">
                    ...
                    <div class="down-content">
                        ...
                        <h4>Bret D. Bowers</h4>
                        <p>Distillerie tatouée de clichés amers 8-bit. Keytar succulentes église végétalienne sans gluten clé
                ...
                <div class="contact-form">
                    <form id="contact" action="" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <fieldset>
                                    <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Votre adresse email"
                                           required="">
                                </fieldset>
                            </div>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <p>Copyright &copy; 2024 Urban 5 - Designed by <a rel="nofollow" href="#" class="tm-text-link"
                                                                  target="_parent">XXXXXX</a></p>
                <p>Made with ❤️ by <a href="#" rel="nofollow">XXXXXX</a></p>
            </div>
        </div>
    </div>
</footer>
